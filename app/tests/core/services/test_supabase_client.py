...
def mock_supabase_client():
    ...
    mock.execute.return_value = {"data": "result"}
    return mock
...
class TestSupabaseClient:
    ...
    def test_init_raises_without_env_vars(self, mock_create_client, mock_logger):
    ...
    def test_insert_calls_correct_chain(
        ...
        mock_supabase_client.insert.assert_called_with({"name": "John"})
    ...
    def test_select_with_filters(
        ...
        mock_supabase_client.eq.assert_called_with("active", True)
    ...
    def test_select_without_filters(
        ...
        mock_supabase_client.select.assert_called_with("*")
        mock_supabase_client.eq.assert_not_called()
    ...
    def test_update_with_filters_and_data(
        ...
        mock_supabase_client.update.assert_called_with({"name": "Updated"})
        mock_supabase_client.eq.assert_called_with("id", 1)
    ...
    def test_delete_with_filters(
        ...
        mock_supabase_client.delete.assert_called()
        mock_supabase_client.eq.assert_called_with("id", 1)
